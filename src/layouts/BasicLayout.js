...
class BasicLayout extends React.PureComponent {
  ...
  getBaseRedirect = () => {
    ...
    // Here is the redirected address redirected to the url's redirect parameter
  ...
  render() {
    ...
    const layout = (
      <Layout>
        <SiderMenu
          logo={logo}
          // Without the Authorized parameter, if there is no permission, it will force jump to the 403 interface.
